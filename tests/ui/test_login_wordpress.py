...
#For test_check_login_passed:
#Existing user credentials provided in the environment variables. 
#Set your user  credentials in MY_WORDPRESS_LOGIN and MY_WORDPRESS_PASSWORD env variables
#Set your user name in assert messages text
def test_check_login_passed(wordpress_ui_client):
    ...
    assert wordpress_ui_client.get_user_profile_link().text == "Profiles\nLogged in as: yuliia999\nLog Out"
